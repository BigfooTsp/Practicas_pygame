'''
Explicación en 
https://www.youtube.com/watch?v=rEYR8On86kk&index=9&list=PLPOv7bTzpLUsHikz39jnTnL0DYMVFiVt4
'''

import base64 # codificación que utiliza el archivo tile
import StringIO
import json
import gzip # compresión del tileset
import pygame
...
class Mapa(object):
    ...
    def cargarMapa(self,Nivel):
        ...
        # cargando mapa de json a variable 'f'
    ...
    def array_Tileset(self,img):
        ...
        for i in range(len(self._mapaImagenes)):
            # Duplica el tamaño de los tiles
