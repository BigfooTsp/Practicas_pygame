...
class MenuState(gamestate.GameState):
    ...
    def __init__(self, parent):
        ...
        self.escribir = letra.render(u"Pulsa \"J\" para JUGAR", 1, (250, 250, 250))
        self.escribir2 = letra.render(u"Pulsa \"ESC\" para SALIR", 1, (250, 250, 250))
        self.escribir3 = letra.render(u"Pulsa \"C\" para CARGAR", 1, (250, 250, 250))
    ...
    def draw(self):
        ...
        self.parent.screen.blit(self.escribir2, (30, 10))
